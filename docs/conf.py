...
htmlhelp_basename = 'qgridnextdoc'
...
latex_documents = [
  (master_doc, 'qgridnext.tex', u'qgridnext Documentation',
...
man_pages = [
    (master_doc, 'qgridnext', u'qgridnext Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'qgridnext', u'qgridnext Documentation',
   author, 'qgridnext', 'One line description of project.',
   'Miscellaneous'),
]
